...
const liste = [
  {
    ...
    details: "C'est un délicieux gâteau au chocolat, parfait pour toutes les occasions.",
  },
  {
    id: 2,
    title: "Pizza Délicieuse",
    description: "Un plat Malgache classique garni de mozzarella, de tomates et de basilic.",
    price: "20000 Ar",
  ...
  },
  {
    ...
    details: "Des frites dorées et croquantes, accompagnées d'une sauce maison.",
  },
];
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      {liste.map(item => (
        <div
          key={item.id}
          className="bg-white rounded-xl shadow-md overflow-hidden w-72 hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300 ml-6"
        >
